...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "BombX", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
MACRO_CONFIG_INT(SvBombFuse, sv_bomb_fuse, 20, 1, 60, CFGFLAG_SERVER, "Bomb lifespan (default 20)")
MACRO_CONFIG_INT(SvStunTime, sv_stun_time, 450, 0, 5000, CFGFLAG_SERVER, "Time enemies will remain stunned in milliseconds (default 450)")
